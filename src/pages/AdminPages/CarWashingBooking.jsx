           ...
           <div style={{marginLeft: 'calc(190px + 5%)',width: '70%',marginTop:'5px' }}>
            <Aheader></Aheader>
              <nav style={{width:'100%', backgroundColor:'white',alignContent:'center',marginTop:'20px',  border:'2px solid gray',padding:'10px'}}>
                       ...
                       <Link  style={{cursor:'pointer', textDecoration:'none',color:'black'}}>Car Washing Booking</Link>
                        </p>
                      </nav>
         
    
    <h3 style={{marginTop:'50px'}}>Total Bookings</h3>
        ...
        {data.map((item) => (
          <tr key={item._id}>
            ...
            <td style={styles.td}>{item.washingPoint}</td>
              <td style={styles.td}>{item.washDate}/{item.washTime}</td>
